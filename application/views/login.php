              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Silueta System Demand</h1>
                  </div>
                  <?php echo form_open('admin/login/submit', array('class' => 'user')); ?>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username" autofocus="" name="user">
                    </div>
                    <div class="form-group">
